...
class Invoice extends CI_Controller {
    ...
    $this->invoice_currency = array('USD'=>'USD','INR'=>'INR','AED'=>'AED','QAR'=>'QAR','GBP'=>'GBP','CAD'=>'CAD','SAR'=>'SAR');
  	}
  	/**
...
array( 'db' => '`invoice`.`created_at` AS `invoice_date`', 'dt' => 2, 'field' => 'invoice_date' ),
array( 'db' => '`client_management`.`name` AS `client_name`', 'dt' => 3, 'field' => 'client_name' ),
...
array( 'db' => '`users`.`name` AS `user_name`', 'dt' => 4, 'field' => 'user_name' ),
