<form  method="post" role="form" id="form" enctype="multipart/form-data" style="padding: 0px 10px">
   <?php if(isset($data->invoice_id)){?><input type="hidden"  name="id" value="<?php echo isset($data->invoice_id) ?$data->invoice_id : "";?>"> <?php } ?>
   <div class="box-body">
     <div class="form-group form-float">
       <div class="form-line">
       <input type="date" name="created_at" id="invoice_date">
         ...
         <div class="form-line">
            <select id='choose-customer' name="customer_option" class="form-control">
              <option value="0">Select Layout</option>
               <option value="1">Make Custom</option>
      ...
      <div class="form-group form-float customer-list-added">
         <div class="form-line"><label class="form-label"><?php echo lang('client'); ?> </label>
            <?php echo selectBoxDynamic("client_id","client_management","name",isset($data->client_id) ?$data->client_id : "","status", "active");?>
         </div>
      </div>

      <div class="custom-entry-customer-main" style="text-align: -webkit-auto;">
          <div class="form-group">
            <label for="usr">Name:</label>
            <input type="text" class="form-control custom-client-field" id="client_name">
          </div>
          <div class="form-group">
            <label for="gst">GST Number:</label>
            <input type="text" class="form-control custom-client-field" id="gst_num">
          </div>
          <div class="form-group">
            <label for="cmyName">Company Name:</label>
            <input type="text" class="form-control custom-client-field" id="company_name">
          </div>
          <div class="form-group">
            <label for="address">Address:</label>
            <input type="text" class="form-control custom-client-field" id="company_address">
          </div>
      </div>
