			...
			<tbody>
				<tr>
					<td><p>Delimp Technology Pvt. Ltd.</p>
						<p>C-71,Second Floor Sector 2</p>
						<p>Noida-201301</p>
						<p><?php echo 'India' ?></p><p>GST No: 07AAHCD0070H1ZY</p></td>

						<?php if (!empty($arrayClientInfo) && $dataArray['customer_option'] == 1) { ?>
              ...
              <?php if (!empty($clientArray['company_name'])) { ?>
              <p><?php echo $clientArray['company_name']; ?></p>
              <?php } ?>
              <?php if (!empty($clientArray['address'])) { ?>
              <p><?php echo $clientArray['address']; ?></p>
              <?php } ?>
              <?php if (!empty($clientArray['company_gst'])) { ?>
