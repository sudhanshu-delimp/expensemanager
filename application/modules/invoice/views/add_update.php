      ...
      <div class="form-group form-float">
        <div class="form-line">
           <select id='is_paid' name="is_paid" class="form-control">
            <option value="unpaid" <?php if($data->is_paid == 'unpaid'){ echo 'selected'; } ?>>Unpaid</option>
            <option value="partially paid" <?php if($data->is_paid == 'partially paid'){ echo 'selected'; } ?> >Partially Paid</option>
            <option value="paid" <?php if($data->is_paid == 'paid'){ echo 'selected'; } ?>>Paid</option>
           </select>
           <label for="is_paid" class="form-label"><?php echo 'Status'; ?></label>
        </div>
     </div>
     <div class="form-group form-float">
       <div class="form-line">
          <textarea name="note" class="form-control" id="note" rows="5" cols="80" placeholder=""><?php echo $data->note; ?></textarea>
          <label for="note" class="form-label"><?php echo 'Note'; ?></label>
       </div>
    </div>
      <div class="custom-entry-customer-main" style="text-align: -webkit-auto; <?php if(isset($data->invoice_id) && $data->customer_option==1){ echo 'display: block;'; } ?>">
          <div class="form-group">
            ...
            <input type="text" value="<?php if(isset($clientData) && count($clientData) > 0){ echo $clientData->client_name;} ?>" class="form-control custom-client-field" id="client_name" required <?php if(isset($data->invoice_id) && $data->customer_option==2){ echo 'disabled'; } ?>>
          </div>
          <div class="form-group">
            <label for="gst">GST Number:</label>
            <input type="text" value="<?php if(isset($clientData) && count($clientData) > 0){ echo $clientData->gst_num;} ?>" class="form-control custom-client-field" id="gst_num" <?php if(isset($data->invoice_id) && $data->customer_option==2){ echo 'disabled'; } ?>>
          </div>
          <div class="form-group">
            <label for="cmyName">Company Name:</label>
            <input type="text" value="<?php if(isset($clientData) && count($clientData) > 0){ echo $clientData->company_name;} ?>" class="form-control custom-client-field" id="company_name" required <?php if(isset($data->invoice_id) && $data->customer_option==2){ echo 'disabled'; } ?>>
          </div>
          <div class="form-group">
            <label for="address">Address:</label>
            <input type="text" value="<?php if(isset($clientData) && count($clientData) > 0){ echo $clientData->company_address;} ?>" class="form-control custom-client-field" id="company_address" required <?php if(isset($data->invoice_id) && $data->customer_option==2){ echo 'disabled'; } ?>>
          </div>
      </div>
