...
array( 'db' => '`users`.`name` AS `user_name`', 'dt' => 5, 'field' => 'user_name' ),
      ...
      array_push($columns, array( 'db' => '`invoice`.`clientInfo` AS `clientInfo`', 'dt' => 6, 'field' => 'clientInfo'));
      array_push($columns, array( 'db' => '`invoice`.`customer_option` AS `customer_option`', 'dt' => 7, 'field' => 'customer_option'));
		$where = '';
		$j = 0;
    ...
    // echo json_encode($res);
     unset($columns[7]);unset($columns[8]);
