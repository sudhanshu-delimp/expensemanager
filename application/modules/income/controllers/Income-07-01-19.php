	...
	/**
      ...
      */
  	public function ajx_data(){
		...
		$table 		= 'income';
		$joinQuery  =  "FROM income LEFT JOIN  `income_category` AS `income_category0` ON (`income_category0`.`income_category_id` = `income`.`income_category`)
";
		$columns 	= array(
...
array( 'db' => '`income`.`income_description` AS `income_description`', 'dt' => 2, 'field' => 'income_description' ),
array( 'db' => '`income`.`income_amount` AS `income_amount`', 'dt' => 3, 'field' => 'income_amount' ),
array( 'db' => '`income_category0`.`income_category_category_name` AS `income_category_category_name`', 'dt' => 4, 'field' => 'income_category_category_name' ),
);
